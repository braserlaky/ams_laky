...
void loop()                                                  //процедура бесконечного цикла
{
  ...
  if(currentTime >= (loopTime + 1000)){            // сравниваем текущий таймер с переменной loopTime + 1 секунда для задержки в 1 секунду
    ;    // !!! тут надо включать логические переменные
