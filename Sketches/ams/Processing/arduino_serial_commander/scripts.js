...
function timeProviderBackground(state) {
  switch (state) {
    case "1": return "#91A46B"; break;
    case "2": return "#A28D85"; break;
     default: return "#555555"; break;
  }
}

function timeProviderColor(state) {
  switch (state) {
...
function forceBackground(state) {
  switch (state) {
    case "0": return "#6EA1D2"; break;
    case "1": return "#F4A509"; break;
     default: return "#555555"; break;
  }
}

function forceColor(state) {
  switch (state) {
    case "0": return "#ffffff"; break;
    case "1": return "#ffffff"; break;
     default: return "#aaaaaa"; break;
